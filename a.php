...
<head>
    ...
    <style>
        header .song-side::before{
            top: 50px;;
        background:url('image/alka_yagnik/artist.jpeg')  no-repeat  55%  center/contain;
}
    </style>
</head>
<body>
    <header>
        ...
        <div class="song-side">
            ...
            <div class="popular_artists">
                ...
                <div class="item Artist_bx">
                    <li>
                        <a href="arijit.php"><img src="image/arijit/artist.jpeg" alt=""></a>
                    </li>
                    <li>
                    ...
                    <li>
                         <a href="a.php"><img src="image/alka_yagnik/artist.jpeg" alt=""></a>
                    </li>
                </div>
            </div>
        </div>
        ...
        <div class="master-play">
            ...
            <img src="image/arijit/1.png" alt="" id="poster_master_class">
            <h5 id="title">
                True Love 
    ...
    <script src="alka_yagnic.js"></script>
</body>
</html>