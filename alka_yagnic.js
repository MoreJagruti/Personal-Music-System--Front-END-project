...
const music = new Audio('songs/alka_yagnik/1.mp3');
...
const songs = [
    {
        id: 1,
        songName: `Raah Main Unse Mulaquat Mere <br><div class="subTitle">
Kumar Sanu - Vijaypath
</div>`,
        poster: "image/alka_yagnik/1.png"
    },
    {
        id: 2,
        songName: `Na Na Karte Pyar <br><div class="subTitle">Udit Narayan - Dhadkan </div>`,
        poster: "image/alka_yagnik/2.png"
    },
    {
        id: 3,
        songName: `Mujhe Pyar HuaAlhamiya <br><div class="subTitle">Alka Yagnik - Judaai </div>`,
        poster: "image/alka_yagnik/3.png"
    },
    {
        id: 4,
        songName: `Raja Ko Rani Se <br><div class="subTitle">Kumar Sanu - Akele Hum Akele Tum  </div>`,
        poster: "image/alka_yagnik/4.png"
    },
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((e) => {
    ...
    index = el.target.id ;
    music.src = `songs/alka_yagnik/${index}.mp3`;
    poster_master_class.src = `image/alka_yagnik/${index}.png`;
    music.play();
    masterPlay.classList.remove('bi-play-fill');
    masterPlay.classList.add('bi-pause-fill');
    download_music.href = `songs/alka_yagnik/${index}.mp3`;
